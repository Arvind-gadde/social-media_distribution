...
const menuContentClass = cn(
  'z-50 min-w-[12rem] overflow-hidden rounded-lg border p-1',
...
const menuItemClass = cn(
  ...
  'text-sm text-gray-700 dark:text-gray-300 outline-none',
  'transition-colors',
  'focus:bg-gray-50 dark:focus:bg-gray-800 focus:text-gray-900 dark:focus:text-gray-100',
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && 'pl-8',
      destructive &&
        'text-error-700 dark:text-error-400 focus:bg-error-50 dark:focus:bg-error-950 focus:text-error-700 dark:focus:text-error-300',
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2.5 py-1.5 text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400',
      inset && 'pl-8',
      className
    )}
    {...props}
